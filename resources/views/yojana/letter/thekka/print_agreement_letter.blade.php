        ...
        <div class="letter_wrap" id="print_letter">
            ...
            <div class="letter_inner">
                ...
                <div class="letter_body">
                    ...
                    {{-- kul lagat table --}}
                    <p class="text-center my-3 font-weight-bold" style="text-align: center;">{{ __('योजनाको कुल लागत अनुमान') }}</p>
                    <table class="letter_table table table-bordered">
                        <tr>
                    ...
                    <p class="text-center my-3 font-weight-bold" style="text-align: center;">
                    ...
                    <p class="mt-1 mb-2 text-center" style="text-align: center;">
                    ...
                    {{-- other bibaran data --}}
                    <p class="text-center my-3 font-weight-bold" style="text-align: center;">{{ __('कार्यालयको तर्फबाट') }}</p>
                    <table class="letter_table table table-bordered">
                        <tr>
                            <th class="text-center">{{ __('नाम') }}</th>
