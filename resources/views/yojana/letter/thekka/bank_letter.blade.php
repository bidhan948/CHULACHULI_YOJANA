        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="letter_wrap">
                    <form action="{{ route('print.plan.letter.thekka.bank') }}" method="get" target="_blank">
                        ...
                        <div class="letter_inner">
                            ...
                            <div class="letter_body">
                                ...
                                <p class="letter_text">
                                    ...
                                    र {{ $contract_kabol_single->listRegistrationAttribute->name .' '.$contract_kabol_single->listRegistrationAttribute->listRegistration->name }} विच
                                    ...
                                    नाममा बैंक खाता आवश्यक भएकाले {{ $contract_kabol_single->listRegistrationAttribute->listRegistration->name  }}को 
