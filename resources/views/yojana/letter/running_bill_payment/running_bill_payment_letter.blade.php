        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="letter_wrap">
                    <form action="{{ route('plan.letter.printRunningBillPaymentLetter') }}" method="get" target="_blank">
                        ...
                        <div class="letter_inner">
                            ...
                            <div class="letter_subject">विषय:- मुल्यांकनको आधारमा रकम भुक्तानी सम्बन्धमा ।</div>
