                        ...
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('plan.contract-sifarish-letter', $reg_no) }}">{{ __('सम्झौताको सिफारिस') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('plan.letter.mulyankan_bhuktani', $reg_no) }}">{{ __('मुल्यांकनको आधारमा भुक्तानी सिफारिस') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-3">
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('plan.letter.final_payment_sifaris', $reg_no) }}">{{ __('अन्तिम भुक्तानीको  सिफारिस') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
