                                ...
                                <div id="kul_lagat_bibaran" class="collapse " aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <div class="container">
                                            <div class="row mx-2">
                                                <div class="col-4">
                                                    <span>{{ __('गाउँपालिकाबाट अनुदान : ') }}</span> <span
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                ...
                                                name="end_date" id="end_date" value="{{$other_bibaran->end_date}}" {{$add_deadline == null ? '' : 'disabled'}}>
                                            @error('end_date')
                                                <p class="invalid-feedback" style="font-size: 0.9rem">
                                ...
                                <div class="col-6">
                                    <div class="form-group mt-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text"
                                                class="form-control my-date form-control-sm number @error('agreement_date_nep') is-invalid @enderror"
                                                name="agreement_date_nep" value="{{$other_bibaran->agreement_date_nep}}">
