        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="letter_wrap">
                    <form action="{{route('print.program.letter.FinalPaymentLetter')}}" method="post" target="_blank">
                        @csrf
                        <input name="program_id" value="{{ $program->id }}" type="hidden">
                        <input name="work_order_id" value="{{ $work_order->id }}" type="hidden">
                        <input name="final_payment_id" value="{{$final_payment->id}}" type="hidden" >
                        <div class="letter_inner">
                            ...
                            <div class="letter_body">
                                ...
                                <p class="letter_text my-2">
                                    ...
                                    तपशिल बमोजिम भुक्तानी दिनका लागी श्रीमान समक्ष यो टिप्पणी पेश गरको छु । 
                                </p>
                                ...
                                @foreach($final_payment->programPaymentFinalDeduction as $deduction)
                                    <tr>
                                        <td>{{$deduction->Deduction->name}}</td>
                                        <td style="font-weight: lighter;">
                                        	{{NepaliAmount($deduction->amount)}}
                                        </td>
                                    </tr>
                                @endforeach
                                    <tr>
