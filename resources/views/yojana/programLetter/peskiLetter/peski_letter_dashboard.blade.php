                        ...
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('program.letter.advanceLetterForm', [$reg_no, 'advanceLetter']) }}">{{ __('पेश्की सम्झौताको टिप्पणी ') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-3">
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('program.letter.advanceLetterForm', [$reg_no, 'financialAdministrationLetter']) }}">{{ __('आर्थिक प्रशासन शाखा पत्र') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
